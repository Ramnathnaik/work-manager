...
const AddTask = () => {
  ...
  const handleAddTask = async (event) => {
    ...
    try {
      ...
      toast.update(id, { render: "Task created successfully!", type: "success", isLoading: false, autoClose: 3000 });
    } catch (error) {
      console.log(error);
      toast.update(id, { render: "Task creation failed!", type: "error", isLoading: false, autoClose: 3000 });
    }
    ...
    <div className="grid grid-cols-12">
      <div className="col-span-6 col-start-4 p-5 mt-3">
        ...
        <form action="#!" onSubmit={handleAddTask}>
          ...
          <div className="flex justify-center space-x-8 mt-4 mb-3">
